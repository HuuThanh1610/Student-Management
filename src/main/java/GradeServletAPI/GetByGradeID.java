 ...
 */
public class GetByGradeID extends HttpServlet {
...
//                    ? (List<Subject>) cacheSubject.getOrDefault("listSubject", new ArrayList<>()) : connectDB.SubjectListing();
            Grade findgrade = gradeDB.findGradeByMarkID(Integer.parseInt(markID));
            if (findgrade != null) {
                ...
                result.add(findgrade);
                List<GradeView> gradeView = result.stream()
