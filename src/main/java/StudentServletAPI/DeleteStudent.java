    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!studentDB.checkExistStudentbyStudentID(Integer.parseInt(studentID))) {
                out.print(new Gson().toJson(new StudentAPIResponse("Stduent does not exist to delete.", HttpServletResponse.SC_BAD_REQUEST, null)));
                out.flush();
                return;
            }
...
//            Student studentDelete = ComFuncStudent.findStudentByID(lstStudent, Integer.parseInt(studentID));
            boolean studentDelete = studentDB.deleteStudentDatabase(Integer.parseInt(studentID), reason);
            if (studentDelete) {
                ...
                json = gson.toJson(new StudentAPIResponse("Student delete successfully", HttpServletResponse.SC_OK, studentView));
            } else {
                json = gson.toJson(new StudentAPIResponse("Failed to delete student.", HttpServletResponse.SC_BAD_REQUEST, null));
            }
            out.print(json);
            out.flush();
//                // clear data cache
